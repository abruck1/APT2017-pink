...
public class GlobalVars {
    ...
    public static final String MANAGE_URL = "http://phase3.connexus-pink.appspot.com/m_manage?user_email=";

    public static final int MY_PERMISSIONS_REQUEST_INTERNET = 0;
    public static final String EMPTY_COVER_IMAGE_URL = "http://connexus-pink.appspot.com/bootstrap/img/empty_cover_image.png";
    public static final String MY_EMAIL = "agbruck@gmail.com";
}
